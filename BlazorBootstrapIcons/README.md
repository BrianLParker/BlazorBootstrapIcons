...
---|---|
|`<OneTwoThreeIcon />`|123|
|`<OneCircleIcon />`|1-circle|
|`<OneCircle1Icon />`|1-circle-1|
|`<OneCircleFillIcon />`|1-circle-fill|
|`<OneCircleFill1Icon />`|1-circle-fill-1|
|`<OneSquareIcon />`|1-square|
|`<OneSquareFillIcon />`|1-square-fill|
|`<TwoCircleIcon />`|2-circle|
|`<TwoCircle1Icon />`|2-circle-1|
|`<TwoCircleFillIcon />`|2-circle-fill|
|`<TwoCircleFill1Icon />`|2-circle-fill-1|
|`<TwoSquareIcon />`|2-square|
|`<TwoSquareFillIcon />`|2-square-fill|
|`<ThreeCircleIcon />`|3-circle|
|`<ThreeCircle1Icon />`|3-circle-1|
|`<ThreeCircleFillIcon />`|3-circle-fill|
|`<ThreeCircleFill1Icon />`|3-circle-fill-1|
|`<ThreeSquareIcon />`|3-square|
|`<ThreeSquareFillIcon />`|3-square-fill|
|`<FourCircleIcon />`|4-circle|
|`<FourCircle1Icon />`|4-circle-1|
|`<FourCircleFillIcon />`|4-circle-fill|
|`<FourCircleFill1Icon />`|4-circle-fill-1|
|`<FourSquareIcon />`|4-square|
|`<FourSquareFillIcon />`|4-square-fill|
|`<FiveCircleIcon />`|5-circle|
|`<FiveCircle1Icon />`|5-circle-1|
|`<FiveCircleFillIcon />`|5-circle-fill|
|`<FiveCircleFill1Icon />`|5-circle-fill-1|
|`<FiveSquareIcon />`|5-square|
|`<FiveSquareFillIcon />`|5-square-fill|
|`<SixCircleIcon />`|6-circle|
|`<SixCircle1Icon />`|6-circle-1|
|`<SixCircleFillIcon />`|6-circle-fill|
|`<SixCircleFill1Icon />`|6-circle-fill-1|
|`<SixSquareIcon />`|6-square|
|`<SixSquareFillIcon />`|6-square-fill|
|`<SevenCircleIcon />`|7-circle|
|`<SevenCircle1Icon />`|7-circle-1|
|`<SevenCircleFillIcon />`|7-circle-fill|
|`<SevenCircleFill1Icon />`|7-circle-fill-1|
|`<SevenSquareIcon />`|7-square|
|`<SevenSquareFillIcon />`|7-square-fill|
|`<EightCircleIcon />`|8-circle|
|`<EightCircle1Icon />`|8-circle-1|
|`<EightCircleFillIcon />`|8-circle-fill|
|`<EightCircleFill1Icon />`|8-circle-fill-1|
|`<EightSquareIcon />`|8-square|
|`<EightSquareFillIcon />`|8-square-fill|
|`<NineCircleIcon />`|9-circle|
|`<NineCircle1Icon />`|9-circle-1|
|`<NineCircleFillIcon />`|9-circle-fill|
|`<NineCircleFill1Icon />`|9-circle-fill-1|
|`<NineSquareIcon />`|9-square|
|`<NineSquareFillIcon />`|9-square-fill|
|`<ActivityIcon />`|activity|
|`<AirplaneIcon />`|airplane|
|`<AirplaneEnginesIcon />`|airplane-engines|
|`<AirplaneEnginesFillIcon />`|airplane-engines-fill|
|`<AirplaneFillIcon />`|airplane-fill|
|`<AlarmIcon />`|alarm|
...
|`<BoxesIcon />`|boxes|
|`<BoxFillIcon />`|box-fill|
|`<BoxSeamIcon />`|box-seam|
|`<BoxSeamFillIcon />`|box-seam-fill|
|`<BracesIcon />`|braces|
...
|`<BrowserChromeIcon />`|browser-chrome|
|`<BrowserEdgeIcon />`|browser-edge|
|`<BrowserFirefoxIcon />`|browser-firefox|
|`<BrowserSafariIcon />`|browser-safari|
|`<BrushIcon />`|brush|
...
|`<CarFrontIcon />`|car-front|
|`<CarFrontFillIcon />`|car-front-fill|
|`<CartIcon />`|cart|
|`<Cart2Icon />`|cart2|
|`<Cart3Icon />`|cart3|
|`<Cart4Icon />`|cart4|
...
|`<CassetteFillIcon />`|cassette-fill|
|`<CastIcon />`|cast|
|`<CcCircleIcon />`|cc-circle|
|`<CcCircle1Icon />`|cc-circle-1|
|`<CcCircleFillIcon />`|cc-circle-fill|
|`<CcCircleFill1Icon />`|cc-circle-fill-1|
|`<CCircleIcon />`|c-circle|
|`<CCircle1Icon />`|c-circle-1|
|`<CCircleFillIcon />`|c-circle-fill|
|`<CCircleFill1Icon />`|c-circle-fill-1|
|`<CcSquareIcon />`|cc-square|
|`<CcSquareFillIcon />`|cc-square-fill|
|`<ChatIcon />`|chat|
...
|`<CropIcon />`|crop|
|`<CSquareIcon />`|c-square|
|`<CSquareFillIcon />`|c-square-fill|
|`<CupIcon />`|cup|
|`<CupFillIcon />`|cup-fill|
|`<CupHotIcon />`|cup-hot|
|`<CupHotFillIcon />`|cup-hot-fill|
...
|`<FastForwardBtnIcon />`|fast-forward-btn|
|`<FastForwardBtnFillIcon />`|fast-forward-btn-fill|
|`<FastForwardCircleIcon />`|fast-forward-circle|
|`<FastForwardCircleFillIcon />`|fast-forward-circle-fill|
|`<FastForwardFillIcon />`|fast-forward-fill|
|`<FileIcon />`|file|
...
|`<HashIcon />`|hash|
|`<HCircleIcon />`|h-circle|
|`<HCircle1Icon />`|h-circle-1|
|`<HCircleFillIcon />`|h-circle-fill|
|`<HCircleFill1Icon />`|h-circle-fill-1|
|`<HddIcon />`|hdd|
...
|`<HrIcon />`|hr|
|`<HSquareIcon />`|h-square|
|`<HSquareFillIcon />`|h-square-fill|
...
|`<PCircleIcon />`|p-circle|
|`<PCircle1Icon />`|p-circle-1|
|`<PCircleFillIcon />`|p-circle-fill|
|`<PCircleFill1Icon />`|p-circle-fill-1|
|`<PeaceIcon />`|peace|
...
|`<RainbowIcon />`|rainbow|
|`<RCircleIcon />`|r-circle|
|`<RCircle1Icon />`|r-circle-1|
|`<RCircleFillIcon />`|r-circle-fill|
|`<RCircleFill1Icon />`|r-circle-fill-1|
|`<ReceiptIcon />`|receipt|
...
|`<RewindIcon />`|rewind|
|`<RewindBtnIcon />`|rewind-btn|
|`<RewindBtnFillIcon />`|rewind-btn-fill|
|`<RewindCircleIcon />`|rewind-circle|
|`<RewindCircleFillIcon />`|rewind-circle-fill|
|`<RewindFillIcon />`|rewind-fill|
|`<RobotIcon />`|robot|
|`<RouterIcon />`|router|
|`<RouterFillIcon />`|router-fill|
|`<RSquareIcon />`|r-square|
|`<RSquareFillIcon />`|r-square-fill|
|`<RssIcon />`|rss|
...
|`<SignStopIcon />`|sign-stop|
|`<SignStopFillIcon />`|sign-stop-fill|
|`<SignStopLightsIcon />`|sign-stop-lights|
|`<SignStopLightsFillIcon />`|sign-stop-lights-fill|
|`<SignTurnLeftIcon />`|sign-turn-left|
|`<SignTurnLeftFillIcon />`|sign-turn-left-fill|
|`<SignTurnRightIcon />`|sign-turn-right|
|`<SignTurnRightFillIcon />`|sign-turn-right-fill|
|`<SignTurnSlightLeftIcon />`|sign-turn-slight-left|
|`<SignTurnSlightLeftFillIcon />`|sign-turn-slight-left-fill|
|`<SignTurnSlightRightIcon />`|sign-turn-slight-right|
|`<SignTurnSlightRightFillIcon />`|sign-turn-slight-right-fill|
|`<SignYieldIcon />`|sign-yield|
|`<SignYieldFillIcon />`|sign-yield-fill|
|`<SimIcon />`|sim|
...
|`<ToolsIcon />`|tools|
|`<TornadoIcon />`|tornado|
|`<TrainFreightFrontIcon />`|train-freight-front|
|`<TrainFreightFrontFillIcon />`|train-freight-front-fill|
|`<TrainFrontIcon />`|train-front|
|`<TrainFrontFillIcon />`|train-front-fill|
|`<TrainLightrailFrontIcon />`|train-lightrail-front|
|`<TrainLightrailFrontFillIcon />`|train-lightrail-front-fill|
...
|`<TruckFrontIcon />`|truck-front|
|`<TruckFrontFillIcon />`|truck-front-fill|
|`<TsunamiIcon />`|tsunami|
|`<TvIcon />`|tv|
|`<TvFillIcon />`|tv-fill|
|`<TwitchIcon />`|twitch|
...
|`<UnindentIcon />`|unindent|
|`<UnionIcon />`|union|
|`<UnityIcon />`|unity|
|`<UniversalAccessIcon />`|universal-access|
|`<UniversalAccessCircleIcon />`|universal-access-circle|
|`<UnlockIcon />`|unlock|
